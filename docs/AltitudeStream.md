...
| **data** | **Array&lt;Float&gt;** | The sequence of altitude values for this stream, in meters | [optional] |
...
instance = StravaClient::AltitudeStream.new(
  original_size: null,
  resolution: null,
  series_type: null,
  data: null
