...
| **data** | **Array&lt;Integer&gt;** | The sequence of heart rate values for this stream, in beats per minute | [optional] |
...
instance = StravaClient::HeartrateStream.new(
  original_size: null,
  resolution: null,
  series_type: null,
  data: null
