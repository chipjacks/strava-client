# StravaClient::SmoothVelocityStream
...
| **data** | **Array&lt;Float&gt;** | The sequence of velocity values for this stream, in meters per second | [optional] |
...
instance = StravaClient::SmoothVelocityStream.new(
  original_size: null,
  resolution: null,
  series_type: null,
  data: null
