...
| **start_date** | **Time** | The time at which the lap was started. | [optional] |
| **start_date_local** | **Time** | The time at which the lap was started in the local timezone. | [optional] |
