...
# Unit tests for StravaClient::LatLngStream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LatLngStream' do
  before do
  ...
  describe 'test an instance of LatLngStream' do
    it 'should create an instance of LatLngStream' do
      expect(@instance).to be_instance_of(StravaClient::LatLngStream)
    end
  end
