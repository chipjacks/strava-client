...
# Unit tests for StravaClient::DistanceStream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DistanceStream' do
  before do
  ...
  describe 'test an instance of DistanceStream' do
    it 'should create an instance of DistanceStream' do
      expect(@instance).to be_instance_of(StravaClient::DistanceStream)
    end
  end
