...
# Unit tests for StravaClient::BaseStream
...
describe 'BaseStream' do
  ...
  describe 'test an instance of BaseStream' do
    it 'should create an instance of BaseStream' do
      expect(@instance).to be_instance_of(StravaClient::BaseStream)
    end
  end
