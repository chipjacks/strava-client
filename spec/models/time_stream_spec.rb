...
# Unit tests for StravaClient::TimeStream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimeStream' do
  before do
  ...
  describe 'test an instance of TimeStream' do
    it 'should create an instance of TimeStream' do
      expect(@instance).to be_instance_of(StravaClient::TimeStream)
    end
  end
