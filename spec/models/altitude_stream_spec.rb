...
# Unit tests for StravaClient::AltitudeStream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AltitudeStream' do
  before do
  ...
  describe 'test an instance of AltitudeStream' do
    it 'should create an instance of AltitudeStream' do
      expect(@instance).to be_instance_of(StravaClient::AltitudeStream)
    end
  end
