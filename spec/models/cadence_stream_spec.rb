...
# Unit tests for StravaClient::CadenceStream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CadenceStream' do
  before do
  ...
  describe 'test an instance of CadenceStream' do
    it 'should create an instance of CadenceStream' do
      expect(@instance).to be_instance_of(StravaClient::CadenceStream)
    end
  end
