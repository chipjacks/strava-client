...
# Unit tests for StravaClient::PowerStream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PowerStream' do
  before do
  ...
  describe 'test an instance of PowerStream' do
    it 'should create an instance of PowerStream' do
      expect(@instance).to be_instance_of(StravaClient::PowerStream)
    end
  end
