...
# Unit tests for StravaClient::SmoothGradeStream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SmoothGradeStream' do
  before do
  ...
  describe 'test an instance of SmoothGradeStream' do
    it 'should create an instance of SmoothGradeStream' do
      expect(@instance).to be_instance_of(StravaClient::SmoothGradeStream)
    end
  end
