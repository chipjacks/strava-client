...
# Unit tests for StravaClient::SmoothVelocityStream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SmoothVelocityStream' do
  before do
  ...
  describe 'test an instance of SmoothVelocityStream' do
    it 'should create an instance of SmoothVelocityStream' do
      expect(@instance).to be_instance_of(StravaClient::SmoothVelocityStream)
    end
  end
