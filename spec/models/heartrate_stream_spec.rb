...
# Unit tests for StravaClient::HeartrateStream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HeartrateStream' do
  before do
  ...
  describe 'test an instance of HeartrateStream' do
    it 'should create an instance of HeartrateStream' do
      expect(@instance).to be_instance_of(StravaClient::HeartrateStream)
    end
  end
