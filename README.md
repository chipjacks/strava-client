...
```shell
gem install ./strava-client-2.0.0.gem
```
(for development, run `gem install --dev ./strava-client-2.0.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'strava-client', '~> 2.0.0'
...
## Documentation for Models
 ...
 - [StravaClient::ClubActivity](docs/ClubActivity.md)
 - [StravaClient::ClubAthlete](docs/ClubAthlete.md)
 ...
 - [StravaClient::SportType](docs/SportType.md)
 ...
 - [StravaClient::Waypoint](docs/Waypoint.md)
