...
module StravaClient
  class StreamsApi
    ...
    # @param keys [Array<String>] Desired stream types.
    # @param key_by_type [Boolean] Must be true.
    ...
    # @param key_by_type [Boolean] Must be true.
    # @param [Hash] opts the optional parameters
    # @return [Array<(StreamSet, Integer, Hash)>] StreamSet data, response status code and response headers
    def get_activity_streams_with_http_info(id, keys, key_by_type, opts = {})
      ...
      # resource path
      local_var_path = '/activities/{id}/streams'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'StreamSet'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['strava_oauth']

      new_options = opts.merge(
        :operation => :"StreamsApi.get_activity_streams",
    ...
    def get_route_streams_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/routes/{id}/streams'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"StreamsApi.get_route_streams",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param keys [Array<String>] The types of streams to return.
    # @param key_by_type [Boolean] Must be true.
    # @param [Hash] opts the optional parameters
    # @return [StreamSet]
    ...
    def get_segment_effort_streams_with_http_info(id, keys, key_by_type, opts = {})
      ...
      # resource path
      local_var_path = '/segment_efforts/{id}/streams'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"StreamsApi.get_segment_effort_streams",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_segment_streams_with_http_info(id, keys, key_by_type, opts = {})
      ...
      # resource path
      local_var_path = '/segments/{id}/streams'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"StreamsApi.get_segment_streams",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
