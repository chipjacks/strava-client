...
module StravaClient
  ...
  class SegmentLeaderboardEntry
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'athlete_name')
        self.athlete_name = attributes[:'athlete_name']
      end
    ...
    def hash
      [athlete_name, elapsed_time, moving_time, start_date, start_date_local, rank].hash
    end
