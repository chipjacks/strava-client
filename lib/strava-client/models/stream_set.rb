  ...
  class StreamSet
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `StravaClient::StreamSet` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `StravaClient::StreamSet`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'velocity_smooth')
        self.velocity_smooth = attributes[:'velocity_smooth']
      end

      if attributes.key?(:'heartrate')
      ...
      if attributes.key?(:'watts')
        self.watts = attributes[:'watts']
      end

      if attributes.key?(:'temp')
        self.temp = attributes[:'temp']
      end

      if attributes.key?(:'moving')
        self.moving = attributes[:'moving']
      end

      if attributes.key?(:'grade_smooth')
