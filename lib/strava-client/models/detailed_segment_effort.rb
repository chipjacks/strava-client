  ...
  class DetailedSegmentEffort
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `StravaClient::DetailedSegmentEffort` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `StravaClient::DetailedSegmentEffort`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'average_heartrate')
        self.average_heartrate = attributes[:'average_heartrate']
      end

      if attributes.key?(:'max_heartrate')
      ...
      if attributes.key?(:'kom_rank')
        self.kom_rank = attributes[:'kom_rank']
      end

      if attributes.key?(:'pr_rank')
    ...
    def kom_rank=(kom_rank)
      if kom_rank.nil?
        fail ArgumentError, 'kom_rank cannot be nil'
      end
    ...
    def pr_rank=(pr_rank)
      if pr_rank.nil?
        fail ArgumentError, 'pr_rank cannot be nil'
      end
