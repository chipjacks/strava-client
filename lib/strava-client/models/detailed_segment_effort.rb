...
module StravaClient
  ...
  class DetailedSegmentEffort
    ...
    def hash
      [id, elapsed_time, start_date, start_date_local, distance, is_kom, name, activity, athlete, moving_time, start_index, end_index, average_cadence, average_watts, device_watts, average_heartrate, max_heartrate, segment, kom_rank, pr_rank, hidden].hash
    end
